        ...
        <div className={styles.container}>
          <div className={styles.newsletterContent}>
            <div className={styles.newsletterText}>
              ...
              <p className={styles.newsletterSubtitle}>Subscribe to get the latest news and updates</p>
            </div>
            ...
            <div className={styles.contactInfo}>
              ...
              <p className={styles.contactNumber}>1-800-222-000</p>
            </div>
          </div>
        </div>
      </div>
          ...
          <div className={styles.linksRow}>
            ...
            <div className={styles.linkColumn}>
              ...
              <ul className={styles.linkList}>
                {['Features', 'Solutions', 'Integrations', 'Enterprise', 'Pricing'].map((item) => (
            ...
            <div className={styles.linkColumn}>
              ...
              <ul className={styles.linkList}>
                {['Help Center', 'Documentation', 'Contact Us', 'Status', 'API'].map((item) => (
                  <li key={item} className={styles.linkItem}>
                    <a href="#" className={styles.link}>
                      <span className={styles.linkArrow}>→</span>
                      <span className={styles.linkText}>{item}</span>
